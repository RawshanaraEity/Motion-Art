    ...
    return (
        <div className="mt-28">
            <div className="w-[580px] mx-auto">
                <h2 className="text-[35px] font-medium leading-[55px] text-center">Apply On Any Section Or Enable For Whole Page</h2>
            </div>
            <div className="flex gap-5 mt-20 mx-5">
                <div className="mb-36 border-2 border-[#FFFFFF10] rounded-[20px] p-[30px] bg-gradient-to-b from-[#0D061F] via-[#251E35] to-[#251E35]">
