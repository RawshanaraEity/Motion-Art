            ...
            <div className="flex items-start">
                <div className="w-[730px] px-[10px] mt-0">
                    ...
                    <div className=" mt-[35px]">
                        <button className="text-[20px] px-[35px] py-[20px] rounded-[20px] flex items-center bg-gradient-to-r from-[#5E11FF] to-[#F87516]">Purchase From Envato <span className="text-[20px] font-normal ml-[20px]"><FaArrowRightLong /></span></button>
                    </div>
                </div>
